...
import com.gemo.core.dto.interpreter.InterfaceResult;
...
public class CommonUtils {
	...
	public static <T extends Object> T MapToBean(Set<Converter> converters, Class<T> cls, Map valueMap) throws Exception {
